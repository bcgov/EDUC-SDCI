...
const { createSchoolCache, addDistrictLabels } = require("../components/utils");
const { checkToken } = require("../components/auth");
const { schoolCache, listCache } = require("../components/cache");
...
//Batch Routes
router.get("/:schoolCategory", checkToken, getAllSchools);
